...
plt.tight_layout()
plt.savefig("cinema_unetr3d_training_curves.png", dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig("cinema_unetr3d_test_predictions.png", dpi=150)
plt.close()


# -- Save Model --
save_path = Path("dense_unetr3d_probe_cinema_pretrained.pt")
torch.save(
    {
