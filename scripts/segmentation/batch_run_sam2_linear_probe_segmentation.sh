#!/usr/bin/env bash
#SBATCH --job-name=heartfm-seg-sam2-linear-probe
#SBATCH --array=0-11
...
# SAM2 linear_probe segmentation array job.
...
echo "=== Task ${SLURM_ARRAY_TASK_ID}: dataset=${DATASET} backbone=sam2 model=${MODEL} decoder=linear_probe ==="
