#!/usr/bin/env bash
#SBATCH --job-name=heartfm-seg-cinema-conv-decoder
#SBATCH --array=0-2
...
# CineMA conv_decoder segmentation array job.
...
echo "=== Task ${SLURM_ARRAY_TASK_ID}: dataset=${DATASET} backbone=cinema decoder=conv_decoder ==="
