#!/usr/bin/env bash
#SBATCH --job-name=heartfm-seg-sam2-conv-decoder
#SBATCH --array=0-11
...
# SAM2 conv_decoder segmentation array job.
...
echo "=== Task ${SLURM_ARRAY_TASK_ID}: dataset=${DATASET} backbone=sam2 model=${MODEL} decoder=conv_decoder ==="
